...
Lee `.claude/skills/issue-workflow/SKILL.md` antes de proceder.
...
Siguiendo las lineaciones de `issue-workflow/SKILL.md`, clasifica cada issue por tipo de trabajo y complejidad. Informa al usuario la clasificación.

## 3. Ejecutar según tipo

Sigue el flujo correspondiente definido en `issue-workflow/SKILL.md`:

**Si es Código / Documentación:**
1. Crear branch desde `main` siguiendo las convenciones de branch de `issue-workflow/SKILL.md`
